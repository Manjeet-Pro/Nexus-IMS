...
import { Mail, ArrowRight, CheckCircle, AlertCircle, ArrowLeft, Shield } from 'lucide-react';
                ...
                <div className="p-8 md:p-12">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-500 mt-3 leading-relaxed">
                            Don't worry, it happens! Enter your email and we'll send you reset instructions.
                        </p>
                    </div>
                        ...
                        <div className="text-center space-y-8 animate-in fade-in zoom-in duration-500">
                            <div className="p-6 bg-green-50 rounded-2xl border border-green-100 flex flex-col items-center gap-4">
                                ...
                                <div className="space-y-1">
                                    <h3 className="text-xl font-bold text-green-800">Email Sent Successfully!</h3>
                                    <p className="text-green-700 opacity-90 text-sm">Please check your inbox (and spam folder) for reset instructions.</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-gray-50/80 p-5 rounded-2xl border border-dashed border-gray-200">
                                <p className="text-sm text-gray-600 font-medium">
                                    ...
                                    <button
                                        ...
                                        className="ml-2 px-3 py-1 bg-white border border-gray-200 rounded-lg text-primary-600 font-bold hover:text-primary-700 transition-all shadow-sm active:scale-95"
                                    >
                                        Try Again
                                    </button>
                                </p>
