...
import { LayoutDashboard, BookOpen, Clock, Bell, GraduationCap, IndianRupee, Calendar, Award } from 'lucide-react';
            ...
            <div className="h-20 flex items-center px-6 border-b border-gray-100 dark:border-gray-800">
                <div className="flex items-center gap-3 group cursor-pointer" onClick={() => navigate('/')}>
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-[10px] font-bold tracking-widest text-primary-600 dark:text-primary-400 uppercase">Student</span>
                    </div>
                </div>
            </div>
